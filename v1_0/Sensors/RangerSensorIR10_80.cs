...
{
    /// <summary>
    /// Sharp GP2Y0A21 - range 10...80 cm
    /// </summary>
    public class RangerSensorIR10_80 : RangerSensorBase
    {
        private ISharpGP2D12 gp2d12;     // GP2Y0A21 - range 10...80 cm.
        ...
        private const double metersPerUnitIR_10_80 = 0.008d; //25.4d;     // calibrate to get meters for the IR 10-80cm sensors (left and right)
