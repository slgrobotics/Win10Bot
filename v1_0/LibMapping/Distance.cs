...
{
    public interface IDistance : IComparable, ICloneable
    {
    ...
    public class Distance : IDistance
    {
        ...
        /// <returns></returns>
        public static Distance operator / (Distance my, double divider)
        {
            my.Meters /= divider;
            return my;
        }
        ...
        /// <returns></returns>
        public static Distance operator * (Distance my, double multiplier)
        {
            my.Meters *= multiplier;
            return my;
        }
        ...
        {
            return (int)(Meters - ((IDistance)other).Meters);
        }
