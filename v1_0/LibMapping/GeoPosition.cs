...
{
    public interface IGeoPosition : ICloneable
    {
        double Lng  { get; set; }
        double Lat  { get; set; }
        double Elev { get; set; }
        ...
        void moveTo(IGeoPosition to);

        void translate(IDistance byX, IDistance byY);
        void translate(IDirection dir, IDistance by);
        void translateToDirection(IDirection dir, IDistance by);
        ...
        /// <returns></returns>
        double bearingTo(IGeoPosition nextLoc);

        double magneticVariation();

        Distance distanceFrom(IGeoPosition from);
        Distance distanceFromExact(IGeoPosition from);

        GeoPosition add(IGeoPosition a);
        GeoPosition subtract(IGeoPosition a, bool spans180);

        string ToStringWithElev();
    ...
    public class GeoPosition : IGeoPosition, ICloneable
    {
		...
		public GeoPosition(IGeoPosition loc)
		{
			m_X = loc.Lng;
			m_Y = loc.Lat;
			m_H = loc.Elev;
        ...
        public void moveTo(IGeoPosition to)
		{
            m_X = to.Lng;
			m_Y = to.Lat;
			m_H = to.Elev;
		...
		public override bool Equals(object obj)
		{
			...
			IGeoPosition other = (IGeoPosition)obj;
			//other.normalize();
			//normalize();
		...
		// returns bearing in degrees. To get rads, multiply by Math.PI / 180.0d
		public double bearingTo(IGeoPosition nextLoc)
		{
			double Lon1 = this.Lng * Math.PI / 180.0d;
		...
		public GeoPosition add(IGeoPosition a)
		{
		...
		public static double stringLatToDouble(string sLat)
		{
            ...
            switch (MapperSettings.coordStyle)
			{
				...
				case 0:			// N33,17'12" or N33°17'12"
				{
					...
					if(pos1 == -1 || pos2 == -1)
					{
						throw new FormatException("lat - invalid format - needs N33,17'12\" or N33°17'12\"");
					}
				...
				case 1:			// N33,17.123' or N33°17.123'
				{
					...
					if(pos1 == -1)
					{
						throw new FormatException("lat - invalid format - needs N33,17.123' or N33°17.123'");
					}
					double degrees = Convert.ToDouble(sLat.Substring(0, pos1));
		...
		public static double stringLngToDouble(string sLng)
		{
			...
			switch (MapperSettings.coordStyle)
			{
				...
				case 0:			// W117,17'12" or W117°17'12"
				{
					...
					if(pos1 == -1 || pos2 == -1)
					{
						throw new FormatException("lat - invalid format - needs W117,17'12\" or W117°17'12\"");
					}
				...
				case 1:			// W117,17.123' or W117°17.123'
				{
					...
					if(pos1 == -1)
					{
						throw new FormatException("lng - invalid format - needs W117,17.123' or W117°17.123'");
					}
					double degrees = Convert.ToDouble(sLng.Substring(0, pos1));
