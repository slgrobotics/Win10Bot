...
namespace slg.LibMapping
{
    ...
    internal struct Locationwp
    {
        ...
        public double lat;				// Lattitude * 10**7    -- actually not * 10**7 in the file
        public double lng;				// Longitude * 10**7   -- actually not * 10**7 in the file
        public double alt;				// Altitude in centimeters (meters * 100)   -- actually just meters in the file
    };
